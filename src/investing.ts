import { Interval, PairId, Period, PointsCount } from 'investing-com-api';
...
const investing = async(pairId?: string, period: Period = 'P1M', interval: Interval = 'P1D', pointscount: PointsCount = 120): Promise<Array<any>> => {
  try {
